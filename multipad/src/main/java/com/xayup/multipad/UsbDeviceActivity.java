...
public class UsbDeviceActivity extends Activity {
    ...
    public void onCreate(Bundle instance) {
        ...
        setContentView(com.xayup.multipad.R.layout.connected_device);

        TextView c_device_name = findViewById(com.xayup.multipad.R.id.connecteddevice_launchpad_name);
        TextView c_device_vendor = findViewById(com.xayup.multipad.R.id.connecteddevice_vendor);
        ImageView c_device_image = findViewById(com.xayup.multipad.R.id.connecteddeviceImageView1);
        Button accept = findViewById(com.xayup.multipad.R.id.connecteddevice_accept);
    ...
    public Drawable getMidiImagem(Context context, String product) {
        switch (product) {
            case LP_X:
                return context.getDrawable(com.xayup.multipad.R.drawable.lp_x);
            case LP_PRO:
                return context.getDrawable(com.xayup.multipad.R.drawable.lp_pro);
            case LP_OPEN:
                return context.getDrawable(com.xayup.multipad.R.drawable.lp_pro);
            case LP_PRO_MK3:
                return context.getDrawable(com.xayup.multipad.R.drawable.lp_pro_mk3);
            case LP_MK2:
                return context.getDrawable(com.xayup.multipad.R.drawable.lp_mk2);
            default:
