...
public class SkinTheme {
	...
	public static boolean inVariaveisStaticas;
	...
	public SkinTheme(Activity context, ListView listSkins, boolean inVariaveisStaticas) {
		this.context = context;
		this.listSkins = listSkins;
		this.inVariaveisStaticas = inVariaveisStaticas;
	...
	public static void varInstance() {
		...
		//	if(inVariaveisStaticas) playBgimg = context.findViewById(R.id.playbgimg);
	}
    ...
    public static void defaultSkin(Activity context){
